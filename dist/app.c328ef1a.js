...
var key; // Change association key when different state is selected 
  ...
  return regeneratorRuntime.wrap(function _callee$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          chosenOption = selectMenu.options[selectMenu.selectedIndex];
          ...
          key = ghsaKey;
          _context.next = 5;
          return _axios.default.get(api + key + filter);
          ...
          case 0:
            if (result) {
              ...
              for (i = 0; i < data.length; i++) {
                ...
                formatDate = (0, _moment.default)(data[i].date).format('MMMM Do YYYY h:mm');
                row = "<tr>\n\t\t\t\t\t\t\t<td data-label=\"Key\">".concat(data[i].key, "</td>\n\t\t\t\t\t\t\t<td data-label=\"Headline\">").concat(data[i].headline, "</td>\n\t\t\t\t\t\t\t<td data-label=\"SHeadline\">").concat(data[i].subheadline, "</td>\n\t\t\t\t\t\t\t<td data-label=\"StartTime\">").concat(formatDate, "</td>\n\t\t\t\t\t\t</tr>");
                table.innerHTML += row;
              }
            }
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            ...
            endTime = endDate.value; // To-do:
            // Convert startTime and endTime in correct format so only the correct date shows in the result 

            _context4.next = 4;
            return _axios.default.get(api + key + filter + '&from=' + startTime + '&to=' + endTime);
...
},{"regenerator-runtime/runtime":"node_modules/regenerator-runtime/runtime.js","moment":"node_modules/moment/moment.js","axios":"node_modules/axios/index.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
